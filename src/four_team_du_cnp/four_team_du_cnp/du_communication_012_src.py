...
UDP_IP_VORTEX = config['IP']['ip_vortex_012']
UDP_IP_ROS = config['IP']['ip_du_012']
UDP_SEND_PORT = int(config['IP']['port_vortex_012'])
UDP_RECEIVE_PORT = int(config['IP']['port_du_012'])
