...
UDP_IP_VORTEX = config['IP']['ip_vortex_018']
UDP_IP_ROS = config['IP']['ip_du_018']
UDP_SEND_PORT = int(config['IP']['port_vortex_018'])
UDP_RECEIVE_PORT = int(config['IP']['port_du_018'])
