...
# ros2 run multi_du_udpcomm_02_pkg du_communication_013 --ros-args --params-file src/multi_du_udpcomm_02_pkg/config/params_013.yaml
...
UDP_IP_VORTEX = config['IP']['ip_vortex_013']
UDP_IP_ROS = config['IP']['ip_du_013']
UDP_SEND_PORT = int(config['IP']['port_vortex_013'])
UDP_RECEIVE_PORT = int(config['IP']['port_du_013'])
