...
# ros2 run multi_du_udpcomm_02_pkg du_communication_011 --ros-args --params-file src/multi_du_udpcomm_02_pkg/config/params_011.yaml
...
UDP_IP_VORTEX = config['IP']['ip_vortex_011']
UDP_IP_ROS = config['IP']['ip_du_011']
UDP_SEND_PORT = int(config['IP']['port_vortex_011'])
UDP_RECEIVE_PORT = int(config['IP']['port_du_011'])
