...
# ros2 run two_team_du_test du_controller_010 --ros-args --params-file src/two_team_du_test/config/params_010.yaml
...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        ...
        self.receive_request_from_ex = self.create_subscription(Bool,'du_011/request_from_ex', self.receive_request_from_ex_callback, 10)
        self.accept_request_from_ex = self.create_subscription(ExPosAndTeamNumber,'du_011/flag/startup', self.accept_request_from_ex_callback, 10)
