...
# ros2 run two_team_du_test du_controller_017 --ros-args --params-file src/two_team_du_test/config/params_017.yaml
...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        # Initialization
        super().__init__('du_controller_017') # node name
                      
        # Publishers
        self.twist_pub = self.create_publisher(Twist, 'du_017/cmd_vel', 100)
        self.vessel_angular_velocity_pub = self.create_publisher(Float32, 'du_017/vessel_angular_velocity', 10)
        self.cmd_joint_pub = self.create_publisher(JointState, 'du_017/cmd_joint', 100)
        ...
        # Subscribers
        self.subscription = self.create_subscription(Pose, 'du_017/pose',  self.subsc_callback, 10)
        self.subscription_012 = self.create_subscription(Pose, 'du_012/pose',  self.subsc_callback_012, 10)
        self.vessel_angle_sub = self.create_subscription(Float32,'du_017/vessel_angle',self.vessel_angle_callback,10)
        # Excavator Subscribers
        self.flag_startup_sub = self.create_subscription(Bool,'du_017/flag/startup', self.flag_work_start_callback, 10)
        ...
        self.flag_stack_sub = self.create_subscription(JointState,'du_017/flag/stack',self.flag_stack_callback, 10)
