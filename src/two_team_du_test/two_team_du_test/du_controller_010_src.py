...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        ...
        self.receive_request_from_ex = self.create_subscription(Bool,'du_010/request_from_ex', self.receive_request_from_ex_callback, 10)
        self.accept_request_from_ex = self.create_subscription(ExPosAndTeamNumber,'du_010/flag/startup', self.accept_request_from_ex_callback, 10)
    ...
    def timer_callback(self):
        ...
        # self.waypoint_list = [(0.0, 15.0),(10.0, 35.0),(15.0, 15.0),(-55.0,35.0),(-65.0,15.0),(-70.0,35.0)]
