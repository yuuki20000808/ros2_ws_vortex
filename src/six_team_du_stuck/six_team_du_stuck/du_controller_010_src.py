...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        ...
        self.vessel_angular_velocity_pub = self.create_publisher(Float32, 'du_010/vessel_angular_velocity', 10)
        ...
        self.vessel_angle_sub = self.create_subscription(Float32,'du_010/vessel_angle',self.vessel_angle_callback,10)
        # Excavator Subscribers
        self.flag_startup_sub = self.create_subscription(Bool,'du_010/flag/startup', self.flag_work_start_callback, 10)
        ...
        self.flag_stack_sub = self.create_subscription(JointState,'du_010/flag/stack',self.flag_stack_callback, 10)
    ...
    def timer_callback(self):
        ...
        goal = [(-20.0, -35.0),(-10.0, -55.0),(-5.0,-35.0),(-135.0,-55.0),(-145.0,-35.0),(-150.0,-55.0)]  #heichi
