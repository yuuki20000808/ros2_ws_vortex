...
# ros2 run four_team_du_stuck du_controller_012 --ros-args --params-file src/four_team_du_stuck/config/params_012.yaml
...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        ...
        self.flag_startup_sub = self.create_subscription(Bool,'du_012/flag/startup', self.flag_work_start_callback, 10)
    ...
    def timer_callback(self):
        ...
        # stack
        if math.hypot(self.turtlePos[0] - (-90.0),self.turtlePos[1] - (-35.0)) < 3:
            twist_tmp.linear.x = 0.0
