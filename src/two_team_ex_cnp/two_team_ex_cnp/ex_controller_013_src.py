...
from two_team_ex_cnp.a_star import astar
from two_team_ex_cnp.pure_pursuit import pure_pursuit_method
import numpy as np
...
class MinimalPubSubCont(Node):
    ...
    ex_team_number = 2
    soil_hill_position = [[-9.0, 90.0]]
    dump_site_position = [-150.0,60.0]
