...
class MinimalPubSubCont(Node):        
    def __init__(self):   
        ...
        # Publishers
        self.cmd_vel_pub = self.create_publisher(Twist, 'ex_000/cmd_vel', 100)
        self.cmd_joint_pub = self.create_publisher(JointState, 'ex_000/cmd_joint', 100)
               
        # Joy Subscribers
        self.joy_sub = self.create_subscription(Joy, 'ex_000/joy',  self.joy_sub_callback, 10)       
