...
UDP_IP_VORTEX = config['IP']['ip_vortex_003']
UDP_IP_ROS = config['IP']['ip_ex_003']
UDP_SEND_PORT = int(config['IP']['port_vortex_003'])
UDP_RECEIVE_PORT = int(config['IP']['port_ex_003'])
