...
# ros2 run multi_du_udpcomm_02_pkg du_controller_011 --ros-args --params-file src/multi_du_udpcomm_02_pkg/config/params_011.yaml
...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        ...
        self.declare_parameter('param_turtlePublish_controller', 'du_014/cmd_vel')
        self.declare_parameter('param_turtleSubsc_controller', 'du_014/pose')
