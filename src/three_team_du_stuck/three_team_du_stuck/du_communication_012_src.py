...
class MinimalPubSubComm(Node):
    ...
    def __init__(self):
        # Initialization
        super().__init__('du_communication_012')       
        
        self.declare_parameter('param_turtlePublish_communication', 'du_012/pose')
        self.declare_parameter('param_turtleSubsc_communication', 'du_012/cmd_vel')
        ...
        self.status_vessel_angle_pub = self.create_publisher(Float32, 'du_012/vessel_angle', 100)
        ...
        self.vessel_angular_velocity_sub = self.create_subscription(Float32, 'du_012/vessel_angular_velocity', self.vessel_angular_velocity_callback, 10)
        self.subscription_joint = self.create_subscription(JointState, 'du_012/cmd_joint', self.subscription_joint_callback, 10)
