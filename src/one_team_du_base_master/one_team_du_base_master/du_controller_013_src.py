...
# ros2 run one_team_du_base_master du_controller_013 --ros-args --params-file src/one_team_du_base_master/config/params_013.yaml
...
class MinimalPubSubCont(Node):
    ...
    def timer_callback(self):
        ...
        goal = [(-20.0, -35.0),(-10.0, -55.0),(-5.0,-35.0),(-155.0,-55.0),(-165.0,-35.0),(-170.0,-55.0)]
