...
# ros2 run four_team_du_stuck du_controller_010 --ros-args --params-file src/four_team_du_stuck/config/params_010.yaml
...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        # Initialization
        super().__init__('du_controller_011') #node name
                      
        # Publishers
        self.twist_pub = self.create_publisher(Twist, 'du_011/cmd_vel', 100)
        self.vessel_angular_velocity_pub = self.create_publisher(Float32, 'du_011/vessel_angular_velocity', 10)
        self.cmd_joint_pub = self.create_publisher(JointState, 'du_011/cmd_joint', 100)
        ...
        # Subscribers
        self.subscription = self.create_subscription(Pose, 'du_011/pose',  self.subsc_callback, 10)
        self.subscription_012 = self.create_subscription(Pose, 'du_012/pose',  self.subsc_callback_012, 10)
        self.vessel_angle_sub = self.create_subscription(Float32,'du_011/vessel_angle',self.vessel_angle_callback,10)
        # Excavator Subscribers
        self.flag_startup_sub = self.create_subscription(Bool,'du_011/flag/startup', self.flag_work_start_callback, 10)
        ...
        self.flag_stack_sub = self.create_subscription(JointState,'du_011/flag/stack',self.flag_stack_callback, 10)
    ...
    def timer_callback(self):
        ...
        #goal = [(80.0, 100.0),(90.0, 80.0),(95.0,100.0),(35.0,80.0),(20.0,100.0),(15.0,80.0)] #saigai
        ...
        # print(self.state)
        # self.get_logger().info("obstacle:%f"%(self.obstacle_x))
