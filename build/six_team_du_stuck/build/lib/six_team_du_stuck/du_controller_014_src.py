...
# ros2 run four_team_du_stuck du_controller_014 --ros-args --params-file src/four_team_du_stuck/config/params_014.yaml
...
class MinimalPubSubCont(Node):
    ...
    def __init__(self):   
        ...
        self.vessel_angular_velocity_pub = self.create_publisher(Float32, 'du_014/vessel_angular_velocity', 10)
        ...
        self.vessel_angle_sub = self.create_subscription(Float32,'du_014/vessel_angle',self.vessel_angle_callback,10)
        ...
        self.flag_stack_sub = self.create_subscription(JointState,'du_014/flag/stack',self.flag_stack_callback, 10)
