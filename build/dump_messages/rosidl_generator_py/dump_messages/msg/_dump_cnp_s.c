...
bool dump_messages__msg__dump_cnp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dump_messages.msg._dump_cnp.DumpCNP", full_classname_dest, 35) == 0);
  }
  dump_messages__msg__DumpCNP * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of DumpCNP */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dump_messages.msg._dump_cnp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DumpCNP");
